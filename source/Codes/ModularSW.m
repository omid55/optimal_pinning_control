function A = ModularSW(m,n,k,P_intra,P_inter)

% ModularSW generates the adjacenecy matrix of modular small-world networks 
% P_inter being the ptobability of inter-modular connections. 

A = zeros(m*n,m*n);
for i = 1:m;
    AA = SW_SmallWorld(n, k, P_intra); AA = AA.Adj;
